...
#include "mb_params.h"      // for modbus parameters structures
...
#define MB_CHAN_DATA_MAX_VAL                999999 //(6)
...
static void setup_reg_data(void)
{
    ...
    holding_reg_params.holding_data0 = 0.0;
...
void data_changer(void *params) {
    ESP_LOGI(TAG, "Task started");
    uint32_t inputs = 1;

    while (true) 
    {
        holding_reg_params.holding_data0 += 0.1;
        discrete_reg_params.discrete_input0 = inputs & (1 << 0) ? 1 : 0;
        discrete_reg_params.discrete_input1 = inputs & (1 << 1) ? 1 : 0;
        discrete_reg_params.discrete_input2 = inputs & (1 << 2) ? 1 : 0;
        discrete_reg_params.discrete_input3 = inputs & (1 << 3) ? 1 : 0;
        discrete_reg_params.discrete_input4 = inputs & (1 << 4) ? 1 : 0;
        discrete_reg_params.discrete_input5 = inputs & (1 << 5) ? 1 : 0;
        discrete_reg_params.discrete_input6 = inputs & (1 << 6) ? 1 : 0;
        discrete_reg_params.discrete_input7 = inputs & (1 << 7) ? 1 : 0;
        discrete_reg_params.discrete_input8 = inputs & (1 << 8) ? 1 : 0;
        discrete_reg_params.discrete_input9 = inputs & (1 << 9) ? 1 : 0;
...
void app_main(void)
{
    ...
    ESP_ERROR_CHECK(uart_set_line_inverse(MB_PORT_NUM, UART_SIGNAL_RTS_INV));
    ...
    xTaskCreatePinnedToCore(data_changer, "DataTask", 4 * 1024, (void *) NULL, 2, NULL, 0);
